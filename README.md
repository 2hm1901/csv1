...
2. Bam `Them dong` de nhap tay du lieu, hoac `Upload CSV` de nap bang co san.
3. Bam `Gan PDF` tren tung dong de upload file PDF tuong ung. PDF se duoc them watermark `Hoàng Giang - 0969.05.6446`.
4. Ten file PDF se duoc tu dong dien vao cot `Loai_thiet_bi`; neu chua dung thi sua truc tiep trong o nay.
5. Click vao gia tri trong cot `Loai_thiet_bi` de xem file PDF.
